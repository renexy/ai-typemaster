...
export const BeginTest = ({ onSelectDifficulty }: BeginTestProps) => {
  const difficulties = [
    {
      level: 'easy',
  ...
  return (
    <div className="bg-white bg-opacity-95 shadow-lg p-8 rounded-xl h-[600px] w-[500px] relative flex flex-col animate-fadeInSlideUp">
      <div className="text-center mb-8">
        ...
        <Typography variant="h4" sx={{ color: '#4F5882', fontWeight: 600, mb: 1 }}>
          AI TypeMaster
        </Typography>
      ...
      <div className="flex flex-col gap-4 flex-1">
        {difficulties.map((diff) => (
          <Card 
            ...
            onClick={() => onSelectDifficulty(diff.level as 'easy' | 'medium' | 'hard')}
            sx={{
          ...
          >
            <CardContent className="p-6">
              ...
              <Typography variant="body2" sx={{ color: '#4F5882', opacity: 0.8 }}>
                {diff.description}
              </Typography>
            </CardContent>
          </Card>
